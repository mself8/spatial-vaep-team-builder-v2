...
from datatools.representation.atomic import AtomicSPADLSchema
...
def gamestates(actions: Actions, nb_prev_actions: int = 3) -> GameStates:
    ...
    for i in range(1, nb_prev_actions):
        ...
        # ex) a kick-off foul at kickoff shows different characteristics from a normal pass (some values recorded as None)
...
def goalscore(gamestates: GameStates) -> Features:
    ...
    # )
    owngoals = actions["result_id"] == spadlcfg.results.index("owngoal")
